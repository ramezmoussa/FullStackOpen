...
describe('total likes', () => {
    ...
    test('when list has two blogs, sum them up', () => {
...
describe('total likes', () => {
    ...
    test('when list has six blogs, sum them up', () => {
...
describe('favourite blog', () => {
    ...
    test('when list has six blogs, return blog with the most likes', () => {
...
describe('most blogs', () => {
    ...
    test('when list has six blogs, return author with the most blogs', () => {
...
describe('most likes', () => {
    ...
    test('when list has six blogs, return author with the most likes', () => {
